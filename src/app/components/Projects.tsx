    ...
    <div className="min-h-screen bg-[#2C0101] flex flex-col items-center py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-screen-lg px-4">
        ...
        <div className="bg-[#280101] p-6 rounded-lg text-center text-white shadow-md">
          ...
          <img src='/calculator.png' alt='Simple Calculator' className='mt-4 rounded-lg shadow-md' />
        </div>
        ...
        <div className="bg-[#280101] p-6 rounded-lg text-center text-white shadow-md">
          ...
          <img src='/IDcard.png' alt='Simple Calculator' className='mt-4 rounded-lg shadow-md' />
        </div>
        ...
        <div className="bg-[#280101] p-6 rounded-lg text-center text-white shadow-md">
          ...
          <img src='/registration.png' alt='Simple Calculator' className='mt-4 rounded-lg shadow-md' />
        </div>
      </div>
    </div>
  );
